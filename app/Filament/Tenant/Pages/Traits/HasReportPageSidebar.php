...
use App\Filament\Tenant\Pages\FinanceReport;
    ...
    public static function sidebar(): FilamentPageSidebar
    {
        return FilamentPageSidebar::make()
            ...
            ->setNavigationItems([
                ...
                static::generateNavigationItem(FinanceReport::class),
            ]);
    }

    private static function generateNavigationItem(
        string $resource,
        ?string $feature = null
    ): PageNavigationItem {
        $canAccess = $feature
        ...
        if ((new $resource) instanceof Page) {
            $active = Str::of($resource::getRouteName())
                ->exactly(Route::current()->getName());
        }
